...
public:
	...
	public:
		...
		Match(unsigned char *_address, short _length) : address(_address), begin(0), length(_length) {}
		~Match() {}
...
private:
	...
	static std::unordered_map<void*, bool> s_functions;
...
public:
	...
	static void AddFunction(void* start, short length);
