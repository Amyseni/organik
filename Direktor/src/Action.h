...
//     ActionLinks() : m_Next(nullptr), m_Prev(nullptr) {}
//     ActionLinks(Action* _head, Action* _next) 
//         : m_Next(_next), m_Prev(nullptr)
//         {
//             m_Next = nullptr;
//             Action* current = _head ? _head : _next;
//             while (current) {
//                 m_Prev = current;
//                 current = current->m_Links ? current->m_Links->m_Next : nullptr;
//             }
//             if (m_Prev) {
//                 m_Prev->m_Links->m_Next = _next;
//             }
//         }
...
//     inline bool operator()(RValue *in, RValue* out)
//     {
...
// {
//     return (eventLookup.first << 16) | (eventLookup.second & 0xFFFF);
// }
// inline int32_t GetEventHash(int32_t eventType, int32_t eventSubType)
// {
//     return (eventType << 16) | (eventSubType & 0xFFFF);
// }

// bool doApplyVariables(CInstance* self, CInstance* other, RValue* params, RValue* result);
// bool doCallScript(CInstance* self, CInstance* other, RValue* params, RValue* result);
// bool doCallBuiltin(CInstance* self, CInstance* other, RValue* params, RValue* result);
