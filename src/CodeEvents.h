...
namespace Organik
{
    ...
    // void gml_Object_obj_net_global_chat_Step_1_After(CodeEventArgs &Args);
    // void gml_Object_obj_net_global_chat_Other_4_Before(CodeEventArgs &Args);
    // void gml_Object_obj_net_global_chat_Other_4_After(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Step_2_Before(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Step_2_After(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Step_1_Before(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Step_1_After(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Other_4_Before(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Other_4_After(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Other_10_Before(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Other_10_After(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Other_11_Before(CodeEventArgs &Args);
    // void gml_Object_obj_chat_parent_Other_11_After(CodeEventArgs &Args);
    ...
    void MSClientCreate_0_Before(CodeEventArgs &Args);
    void MSClientCreate_0_After(CodeEventArgs &Args);
    void MSClientDestroy_1_Before(CodeEventArgs &Args);
    void MSClientDestroy_1_After(CodeEventArgs &Args);
    // void MSClientStep_2_Before(CodeEventArgs &Args);
    // void MSClientStep_2_After(CodeEventArgs &Args);
    // void MSClientStep_0_Before(CodeEventArgs &Args);
    // void MSClientStep_0_After(CodeEventArgs &Args);
    void MSClientOther_68_Before(CodeEventArgs &Args);
    void MSClientOther_68_After(CodeEventArgs &Args);
    void MSClientOther_25_Before(CodeEventArgs &Args);
    void MSClientOther_25_After(CodeEventArgs &Args);
    void MSClientOther_15_Before(CodeEventArgs &Args);
    void MSClientOther_15_After(CodeEventArgs &Args);
    void MSClientOther_13_Before(CodeEventArgs &Args);
    void MSClientOther_13_After(CodeEventArgs &Args);
    void MSClientOther_12_Before(CodeEventArgs &Args);
    void MSClientOther_12_After(CodeEventArgs &Args);
    void MSClientOther_10_Before(CodeEventArgs &Args);
    void MSClientOther_10_After(CodeEventArgs &Args);
    void MSClientOther_4_Before(CodeEventArgs &Args);
    void MSClientOther_4_After(CodeEventArgs &Args);
    void MSClientDraw_0_Before(CodeEventArgs &Args);
    void MSClientDraw_0_After(CodeEventArgs &Args);
    void MSClientPreCreate_0_Before(CodeEventArgs &Args);
    void MSClientPreCreate_0_After(CodeEventArgs &Args);
    ...
    void gml_Object_obj_allgame_Step_0_After(CodeEventArgs &Args);
}