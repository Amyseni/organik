...
namespace Organik
{
    ...
    {
    protected:
        std::shared_mutex selfLock;
        std::shared_mutex messagesLock;
    ...
    public:
        ...
        inline std::unique_lock<std::shared_mutex> GetLock( ) { return std::move(std::unique_lock<std::shared_mutex>(selfLock)); }
        inline std::shared_lock<std::shared_mutex> GetReadLock( ) { return std::move(std::shared_lock<std::shared_mutex>(selfLock)); }
    protected:
