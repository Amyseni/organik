...
{
    DO_LOG4("%s(%s): #%d", __FILE__, __FUNCTION__, __LINE__);
    ...
    DoBuiltinRef(&gml_buffer_write, result,buffer, eBuffer_String, name.c_str() );
    DoBuiltinRef(&gml_buffer_write, result,buffer, eBuffer_String, message.c_str() );
