...
// HOOK_SCRIPT(scr_weapon_variants_init_ultimate)
// {
...
//         Organik::Objects::ObjIndexes[Organik::Objects::obj_control]
//     ).ToBoolean())
//     {
//         return super(Self, Other, Result, ArgumentCount, Arguments);
//     }
...
//             DoBuiltin(&gml_asset_get_index, "sound_artefact_use").ToInt32()
//         );
//         YYCreateString(ultradrop->InternalGetYYVarRef(VAR_HASH(buffnote)), "USED");
//     }
//     else if (variantpredestinedInt != -1)
//     {
//         rollVariant = variantpredestinedInt;
//         *variantpredestined = -1.0;
//     }
//     else 
//     {    
...
//             !(objIndex & (~1660)))
//         {
//             *Arguments[0] = RValue(Organik::Objects::obj_menu_particle);
...
//     return super(Self, Other, Result, ArgumentCount, Arguments);
// }
// HOOK_SCRIPT(scr_create_bullet)
// {
//     RValue* damagemod = Arguments[7];
//     if (*getReplaceBulletIndex() != 0.0)
//     {
//         CInstance* objControl = CInstance::FirstOrDefault([&](CInstance* ci) -> bool { return ci && ci->m_ObjectIndex ==  Organik::Objects::obj_control; });
...
//     return super(Self, Other, Result, ArgumentCount, Arguments);
// }
// HOOK_SCRIPT(scr_instance_create)
// {
...
//                 *Arguments[2] = RValue(static_cast<double>(getNonArenaChests()[chestType]));
//         }
//     }
//     Result = super(Self, Other, Result, ArgumentCount, Arguments);
...
//     return Result;
// }
// HOOK_SCRIPT(scr_enemy_set_stateChanged)
// {
//     if (ArgumentCount > 1)
//     {
