...
// #define _DEFINE_EVENT_HOOK1(_obj, _event, _subevent) \
// 	namespace { namespace Hook_##_id { \
// 		static void *internalSuper = NULL; \
// 		static auto __stdcall hook (CInstance *self, CInstance *other) ; \
...
// #define _DEFINE_EVENT_HOOK0(_id, _name, _priority, _type) _DEFINE_EVENT_HOOK1(_id, _name, _priority, _type)
// #define HOOK_EVENT(_obj, _event, _subevent) \